...
assert !new File(basedir, 'domain-rest').exists()         : "No presentation modules should be created"
assert !new File(basedir, 'presentation-rest').exists()   : "No presentation modules should be created"
assert !new File(basedir, 'domain-graphql').exists()      : "No presentation modules should be created"
assert !new File(basedir, 'presentation-graphql').exists(): "No presentation modules should be created"
